...
{/* 
                ...
                <div className=" flex flex-col justify-center align-middle m-4 ">
                  <Badge className="mx-auto px-4 m-2  cursor-pointer ">
                    Intraday
                  </Badge>

                  <Badge
                    className="mx-auto px-4 m-2 cursor-pointer text-center"
                    type="neutral"
                  >
                    Delivery
                  </Badge>
              ...
              <div className="flex justify-center">
                ...
                <Button className="px-8 m-2" onClick={() => { setSide('buy'); handleBuyOrder(); }}>Buy</Button>
        ...
        <Card className="min-w-0 shadow-xs overflow-hidden bg-white dark:bg-gray-800 rounded-t-lg rounded-0 mb-4 w-12/12">
          <CardBody>
            <div>
              <h2 className="font-bold text-green-400">Please Select Any Available Scrip</h2>
              <h2 className="font-bold">
