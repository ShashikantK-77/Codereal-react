...
const useStaffSubmit = (id) => {
  ...
  const onSubmit = async (data) => {
    console.log("in useStaffSubmit onSubmit",data );
    try {
  ...
  }, [id, setValue, isDrawerOpen, zenithQuark.email, clearErrors]);

  useEffect(() => {
    if (location.pathname === "/edit-profile" && Cookies.get("zenithQuark")) {
      getStaffData();
    }
    // eslint-disable-next-line react-hooks/exhaustive-deps
