          ...
          <form onSubmit={handleSubmit(handleFormSubmit)}>
            ...
            <div className="grid lg:grid-cols-2 sm:grid-cols-1">
              <div className="flex flex-col justify-center">
                ...
                {/* <Error style={{ marginTop: '-2rem' }} errorName={errors.Username} /> */}
                <Error errorName={errors.Username} shouldDisplay={firstError === 'Username'} />
                ...
                <input type='text' className='hidden' name='uploadphoto' value={photoURL} />
                <Error errorName={errors.uploadphoto} />
