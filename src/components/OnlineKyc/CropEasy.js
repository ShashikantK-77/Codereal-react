...
const CropEasy = ({ photoURL, setOpenCrop, setPhotoURL, setFile , imageWidth,imageHeight }) => {
  ...
  useEffect(() => {
    ...
    const getImageAspect = async () => {
      ...
      const desiredAspectRatio = imageWidth / imageHeight;
  
      // if (aspectRatio < desiredAspectRatio) {
      //   setAspect(aspectRatio);
      // } else {
        setAspect(desiredAspectRatio);
      // }
    };
  ...
  return (
    <div >
      ...
      <div>
        ...
        <div className="relative bg-gray-100  h-64 w-12/12 mx-auto">
