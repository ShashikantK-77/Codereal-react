...
const BankDetails = ({ handleNext, handlePrevious }) => {
    ...
    const handleFormSubmit = async (data) => {
        ...
        //   }
        // if (!photoURL) {
        //   notifyError("Please select Cheque / Bank Passbook photo");
        //   return;
        // }
                    ...
                    <form onSubmit={handleSubmit(handleFormSubmit)}>
                        ...
                        <div className="grid lg:grid-cols-2 sm:grid-cols-1">
                            <div className="flex flex-col justify-center">
                                ...
                                <ImageUpload {...{ photoURL, setOpenCrop, setPhotoURL, setFile, openCrop, label: 'Upload Cheque/Bank Passbook',imagewidth,imageheight }} />
                                <Error errorName={errors.Pasbookphoto} />
                                <h5 className='text-sm text-black'>(Cheque / Bank Passbook any one of these)</h5>
                            </div>
