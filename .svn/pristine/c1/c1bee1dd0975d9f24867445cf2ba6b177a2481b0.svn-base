...
import BrokerDrawerbtn from "components/form/BrokerDrawerbtn";




const AccountBrokerDrawer = ({ id , customer,}) => {
...
const [currentmasteraccount,setCurrentmasteraccount] = useState("")
  ...
  <BrokerDrawerbtn id={id} title="Update AccountBroker"  />
) : (
  <BrokerDrawerbtn id={id} title="Edit Client" />
)}
...
export default AccountBrokerDrawer;
