...
const NomineeDetails = ({ handleNext, handlePrevious }) => {
  ...
  //   const formattedData = {
  //     ...restData,
  //     NomineeBirthdate: formatDate(NomineeBirthdate),// Format the birthdate
  //     NomineeRel: nomineeRel, // Add the nomineeRel value
  //   };

  //   console.log("***************in Nominee Details Step:", formattedData);

  //   onSubmit(formattedData);
  //   notifySuccess("Nominee Details Submited");
  //   window.location.href = '/dashboard';
  //   notifySuccess("Congratulations.Your KYC Submited Successfully..!");
  // };
